...
import {HREF_PAGE_MEDICS, USER_TYPE_MEDIC, USER_TYPE_PATIENT, USER_TYPE_SECRETARY} from "../../models/constants";
import Loading from "../../components/loading";
import MedicProfileHeader from "../../components/medicProfileHeader";
import AuthService from "../../modules/authService";
import Spinner from "../../components/spinner";
import AddMedicTimetable from "../../components/addMedicTimetable";

export default class MedicAddTimetablesPage extends Component {
                                    ...
                                    <div className="kt-portlet kt-portlet--height-fluid">
                                        <div className="kt-portlet__head">
                                            <div className="kt-portlet__head-label">
                                                <h3 className="kt-portlet__head-title">{locales_es.addTimetable}</h3>
                                            </div>
                                        </div>
                                        <div
                                                ...
                                                <div className="kt-widget-2__content kt-portlet__space-x">
                                                    {!medic ? <Spinner/> :
                                                        (userType === USER_TYPE_SECRETARY || userType === USER_TYPE_MEDIC) ?
                                                                <AddMedicTimetable showMainModal={this.props.showMainModal}
                                                                                    userType={userType}
                                                                                    medic={medic}
