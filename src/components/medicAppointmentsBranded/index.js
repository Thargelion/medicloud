...
export default class MedicAppointmentsBranded extends Component {
    constructor(props) {
        super(props);
    ...
    getTimetables() {
        this.api.getTimetables({medic_id: this.props.medic.id, clinic_id: this.state.clinicId}).then(res => {
            this.setState({
                timetables: res.data
            })
        }).catch(err => {
    ...
    setClinic() {
        this.configService.getLocalClinicData().then(res => {
            this.setState({
                ...
                clinicVideocallBaseUrl: res.videocall_base_url,
            }, () => {
                this.getTimetables();
                        ...
                        {this.auth.isLoggedUser() ? null :
                            <div className="alert alert-warning fade show" role="alert">
                                ...
                                <div
                                    ...
                                    <a href={`${HREF_REGISTER_PATIENT}?redirect=${HREF_PAGE_MEDIC}/${this.props.medic.id}`}>{locales_es.registerYourself}</a>&nbsp;{locales_es.or}&nbsp;
                                    <a
